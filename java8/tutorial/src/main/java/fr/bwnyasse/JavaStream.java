...
public class JavaStream {
    ...
    private static List<String> memberNames = Arrays.asList("Amitabh", "Shekhar", "Aman", "Rahul",
    ...
    /**
     * Intermediate operations return the stream itself so you can chain multiple method calls in a
     * row. Let’s learn important ones.
     */
    ...
    private static void terminalOperations() {
        ...
        // count
        long countStartWithA = memberNames.stream().filter((s) -> s.startsWith("A")).count();
